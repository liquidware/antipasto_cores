...
void init()
{
	SETBIT(DDRE,PE7); //DDR for TX buffer
	SETBIT(PORTE,PE7); //disable buffer drive on serial TX pin
	SETBIT(ARDUINO_RESET_PORT, ARDUINO_RESET_PIN); //bring the arduino out of reset
