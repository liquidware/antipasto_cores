...
void beginCanvas(void)
{
    ...
    if (!serverEnb) { Serial.begin(9600); serverEnb = true; }
    ...
    if (buf[0] == '|') 
    {
        ...
        case GET_TOUCH:
          ...
          delay(2);
          Serial.print((unsigned char)mouseX);
          delay(2);
          Serial.print((unsigned char)(mouseX>>8));
          delay(2);
          Serial.print((unsigned char)mouseY);
          delay(2);
          Serial.print((unsigned char)(mouseY>>8));		  
          delay(2);
